...
import { Input, Button, Card, CardBody, Avatar, Chip, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Spinner } from '@heroui/react'
import { MagnifyingGlassIcon, FunnelIcon, EllipsisVerticalIcon, PencilIcon, TrashIcon, UserIcon, EnvelopeIcon, PhoneIcon, EyeIcon } from '@heroicons/react/24/outline'
    ...
    if (loading) {
        return (
            <div className='flex justify-center items-center py-20'>
                <Spinner size="lg" color="secondary" label="Loading temp employees..." />
            </div>
        )
    }
            ...
            {filteredEmployees.length === 0 ? (
                <div className='text-center py-20'>
                    ...
                    <h3 className='text-lg font-semibold text-gray-800 mb-2'>
                        {searchQuery ? 'No matching employees found' : 'No temp employees yet'}
                    </h3>
                    <p className='text-gray-600 text-sm'>
                        {searchQuery ? 'Try adjusting your search terms' : 'Start by adding your first temporary employee'}
                    </p>
                </div>
            ) : (
                    ...
                    {filteredEmployees.map((employee) => (
                        ...
                        >
                            <CardBody className='p-4'>
                                        ...
                                        <DropdownMenu aria-label="Employee Actions">
                                            {canView && (
                                                <DropdownItem 
                                                    ...
                                                    onPress={() => handleEmployeeClick(employee.employeeId || employee._id)}
                                                >
                                                    View Details
                                                </DropdownItem>
                                            )}
                                ...
                                <div 
                                    onClick={() => handleEmployeeClick(employee.employeeId || employee._id)}
                                ...
                                >
                                    ...
                                    <p className='text-xs text-gray-500 mb-3'>ID: {employee.employeeId || 'N/A'}</p>
