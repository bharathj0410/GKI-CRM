    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status == 200) {
                ...
                Toast("Employee Added", `${response.data.message} Employee ID: ${employeeId}`, "success")
                e.target.reset();
                setPermissions([]);
                setTableAccess({});
                setPassword("");
            ...
            Toast("Failed to Add Employee", err.response?.data?.error || "An error occurred", "danger")
            console.log(err)
        } finally {
            setIsLoading(false);
        }
    ...
    return (
        <div className='flex gap-12 items-start justify-center'>
            ...
            <div className="w-full max-w-2xl">
                <div className='mb-5'>
                    <h2 className='text-xl font-bold text-gray-900 mb-1.5'>Add New Employee</h2>
                    <p className='text-gray-600 text-sm'>Fill in the employee details and assign access permissions</p>
                </div>
                ...
                <Form className="w-full space-y-4" onSubmit={onSubmit}>
                    ...
                    <div className='space-y-3 w-full'>
                        <div className='flex items-center gap-2 mb-3'>
                            ...
                            <h3 className='text-base font-semibold text-gray-800'>Employee Type</h3>
                        </div>
                        ...
                        <div className='grid grid-cols-3 gap-3'>
                            ...
                            >
                                <div className='flex flex-col gap-2'>
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        employeeType === "crm_user" ? "border-secondary" : "border-gray-300"
                                    }`}>
                                        {employeeType === "crm_user" && (
                                    ...
                                    <div>
                                        <h4 className='font-semibold text-gray-800 mb-1'>CRM User</h4>
                                        <p className='text-xs text-gray-600'>Full CRM access with login</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div className='flex flex-col gap-2'>
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        employeeType === "data_only" ? "border-secondary" : "border-gray-300"
                                    }`}>
                                        {employeeType === "data_only" && (
                                            <div className='w-3 h-3 rounded-full bg-secondary'></div>
                                        )}
                                    ...
                                    <div>
                                        <h4 className='font-semibold text-gray-800 mb-1'>Employee</h4>
                                        <p className='text-xs text-gray-600'>Contact info only, no access</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div className='flex flex-col gap-2'>
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        employeeType === "temp_employee" ? "border-secondary" : "border-gray-300"
                                    }`}>
                                        {employeeType === "temp_employee" && (
                                            <div className='w-3 h-3 rounded-full bg-secondary'></div>
                                        )}
                                    ...
                                    <div>
                                        <h4 className='font-semibold text-gray-800 mb-1'>Temporary</h4>
                                        <p className='text-xs text-gray-600'>Short-term employee data</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {employeeType === "temp_employee" && (
                        <div className='space-y-3 w-full'>
                            ...
                            <div className='flex items-center gap-2 mb-3 mt-4'>
                                <div className='w-1 h-5 bg-gradient-to-b from-secondary to-primary rounded-full'></div>
                                <h3 className='text-base font-semibold text-gray-800'>Emergency Contact</h3>
                            </div>
                    ...
                    {employeeType === "crm_user" && (
                        ...
                        <div className='bg-purple-50 border border-purple-200 rounded-lg p-3'>
                            ...
                            >
                                <div>
                                    <p className='font-semibold text-gray-800'>Use default password</p>
                                    <p className='text-sm text-gray-600'>Password will be set to: <span className='font-mono bg-purple-100 px-2 py-0.5 rounded'>GKI@123</span></p>
                                </div>
                            </Checkbox>
                        </div>
                        ...
                        <div className='bg-amber-50 border border-amber-200 rounded-lg p-3'>
                            ...
                            >
                                <div>
                                    <p className='font-semibold text-gray-800'>Require password reset on first login</p>
                                    <p className='text-sm text-gray-600'>Employee will be prompted to change password</p>
                                </div>
                            </Checkbox>
                        </div>
                        </div>
                    ...
                    {employeeType === "crm_user" && (
                        ...
                        <div className='flex items-center gap-2 mb-3'>
                            <div className='w-1 h-5 bg-gradient-to-b from-secondary to-primary rounded-full'></div>
                            <h3 className='text-base font-semibold text-gray-800'>Access Permissions & Table Access Control</h3>
                        </div>

                        <div className='bg-gradient-to-br from-secondary/5 to-primary/5 rounded-xl p-4 border-2 border-secondary/20'>
                            <p className='text-sm text-gray-700 mb-4 font-medium'>Select pages and define access levels (View, Edit, Delete) for each table</p>
                            ...
                            <div className='space-y-3'>
                                {tablePermissions.map((table) => {
                                    ...
                                    return (
                                        <div key={table.key} className={`bg-white rounded-lg border-2 transition-all ${
                                            isSelected ? 'border-secondary shadow-md' : 'border-gray-200'
                                        }`}>
                                            <div className='p-3'>
                                                <div className='flex items-start gap-3'>
                                                        ...
                                                        onValueChange={(checked) => {
                                                            if (checked) {
                                                                ...
                                                                if (table.hasTableAccess) {
                                                                    setTableAccess({...tableAccess, [table.key]: ['view']});
                                                                }
                                                            } else {
                                                                setPermissions(permissions.filter(p => p !== table.key));
                                                    ...
                                                    <div className='flex-1'>
                                                        ...
                                                        {isSelected && table.hasTableAccess && (
                                                            <div className='mt-3 flex flex-wrap gap-2'>
                                                                {accessLevels.map((level) => {
                                                                    const hasAccess = currentAccess.includes(level.key);
                                                                    return (
                                                                        <button
                                                                            key={level.key}
                                                                            type='button'
                                                                            onClick={() => {
                                                                                if (hasAccess) {
                                                                                    setTableAccess({
                                                                                        ...tableAccess,
                                                                                        [table.key]: currentAccess.filter(a => a !== level.key)
                                                                                    });
                                                                                } else {
                                                                                    setTableAccess({
                                                                                        ...tableAccess,
                                                                                        [table.key]: [...currentAccess, level.key]
                                                                                    });
                                                                                }
                                                                            }}
                                                        ...
                                                        {isSelected && !table.hasTableAccess && (
                                                            <p className='text-xs text-gray-500 mt-2'>✓ Full access granted</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
