      ...
      <div className="flex justify-between gap-4 items-end">
        <Input
          ...
          classNames={{
            input: "text-sm",
            inputWrapper:
              "h-12 border-2 border-gray-200 dark:border-gray-700 hover:border-secondary-300 dark:hover:border-secondary-600",
          }}
        />
        <Button
          color="secondary"
      ...
      <div className="py-4 px-2 flex justify-between items-center bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-800/80 rounded-xl border border-gray-200 dark:border-gray-700">
        <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">
          ...
          <span className="text-secondary-600 dark:text-secondary-400">
            {items.length > 0 ? (page - 1) * rowsPerPage + 1 : 0}
          </span>{" "}
          to{" "}
          <span className="text-secondary-600 dark:text-secondary-400">
