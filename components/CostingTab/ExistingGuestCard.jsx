...
const INITIAL_VISIBLE_COLUMNS = ["logo","company/person_name", "company_type","billing_address_line","billing_city","billing_state","billing_country", "actions"];

export default function ExistingGuestCard({ setSelectedGuestId, setSelectedKey }) {
    ...
    function onClickGenerateQuotation(selectedKeys) {
        if (selectedKeys.size) {
            ...
            Toast("Product Not Selected", "Oops! Please select at least one product before proceeding", "danger")
        }
    }
            ...
            <div className="flex flex-col gap-4">
                <div className="flex justify-between gap-3 items-end">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button color="secondary" endContent={<PlusIcon />} onPress={() => setSelectedKey ? setSelectedKey("new_guest") : router.push('/costing/new-guest')}>
                            Add New
                        </Button>
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">Total {guests.length} guests</span>
    ...
    return (
        <div>
            ...
            >
                ...
                <TableBody isLoading={isLoading} emptyContent={"No guests found"} items={sortedItems} loadingContent={<Spinner label="Loading..." />}>
                    {(item) => (
                        <TableRow key={item.id} className="hover:cursor-pointer" onClick={()=>setSelectedGuestId(item.id)}>
