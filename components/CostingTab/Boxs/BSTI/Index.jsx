...
export default function Index({ ref, handleDownload, data, handleSelectionChange }) {
  ...
  return (
    <div className='w-full'>
      <div ref={ref} className='bg-white p-5'>
        ...
        <div className='font-bold flex text-sm pr-10 justify-end'>Note: All dimensions are in <div className='text-secondary'>&nbsp;{unit}</div></div>
        <BSTI labelL={labelL}
          labelW={labelW}
          labelH={labelH}
          labelPF={labelPF}
      ...
      <div className='flex items-center justify-center w-full pt-10'>
        <div className='grid grid-cols-4 gap-4 '>
          <NumberInput
            ...
            placeholder='Length'
            onValueChange={(value) => { handleSelectionChange("labelL", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelW", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelH", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelPF", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelTF", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelF", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelC", value) }}
            size='sm'
          />
          <NumberInput
            hideStepper
            ...
            onValueChange={(value) => { handleSelectionChange("labelD", value) }}
            size='sm'
          />
