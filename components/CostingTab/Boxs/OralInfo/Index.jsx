...
export default function Index({ ref, data, handleSelectionChange }) {
  const [unit, setUnit] = useState(
    data?.oralInfoUnit ? data.oralInfoUnit : "centimeter",
  );
  ...
  useEffect(() => {
    ...
    let C = CalculateC(
      toNumberOrZero(data.articleWidth),
      toNumberOrZero(data.wrapThickness),
      toNumberOrZero(data.plateThickness),
      toNumberOrZero(data.horizontalArtical),
    );
    ...
    <div className="w-full">
      <div ref={ref} className="bg-white p-5">
        ...
        <div className="flex items-center justify-center">
          <OralInfo
            labelL={data?.articleLength ? data.articleLength : "L"}
            labelW={data?.articleWidth ? data.articleWidth : "W"}
            HorizontalCount={
              data?.horizontalArtical ? data.horizontalArtical : 1
            }
      ...
      <div className="flex items-center justify-center w-full pt-10">
        <div className="grid grid-cols-4 gap-4 ">
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("articleLength", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("articleWidth", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("horizontalArtical", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("verticalArtical", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("plateThickness", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("boxThickness", value)
            }
            size="sm"
          />
          <NumberInput
            ...
            onValueChange={(value) =>
              handleSelectionChange("wrapThickness", value)
            }
            size="sm"
          />
        </div>
