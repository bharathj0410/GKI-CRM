  ...
  function onClickGenerateQuotation(productId) {
    if (productId) {
      ...
      Toast(
        ...
        "Oops! Please select a product before proceeding",
        "danger",
      );
    }
  }
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="flex gap-3 justify-end flex-wrap">
            ...
            <Button color="primary" onPress={() => setSelectedAction("edit")}>
              Edit
            </Button>
            <Button color="danger" onPress={() => setSelectedAction("delete")}>
              Delete
            </Button>
          </div>
        </div>
