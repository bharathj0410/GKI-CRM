...
export default function ProductCard({ data,buttonAction }) {
    const cardData = () => <div className='p-4 rounded-lg w-full bg-zinc-200 flex flex-col gap-2 text-xs'>
                    ...
                    <Table aria-label="Example static collection table" className="text-xs w-full">
                <TableHeader>
