...
const convertToBase64 = (file) => {
  ...
  return (
    <Form className="w-full p-6 rounded-2xl  flex items-center " onSubmit={onSubmit}>
      <div className="text-2xl font-bold text-gray-700">Company & Billing Information</div>
        ...
        <Input type="file" accept="image/*" onChange={handleFileChange} ref={fileInputRef} className='hidden' />
            <div className='flex relative row-span-3 '>
                ...
                <div  role="button" onClick={handleButtonClick} className='w-full'>
                    ...
                    {image ? <img src={imagePreview} alt="Preview" className='h-[15rem] w-[15rem] object-fill z-10 relative rounded-full' /> : <div className=' bg-zinc-100 h-[15rem] w-[15rem] flex flex-col items-center justify-center rounded-full text-zinc-500'><PhotoIcon className=' w-10' /> <p className='text-xs font-bold '>Upload Logo</p></div>}
      ...
      <div className='w-full col-span-3'>
        <p className="block text-sm font-medium text-gray-700 p-1">Company Name / Person Name</p>
      ...
      {/* Company Type */}
      <div className='w-full col-span-3'>
        <p className="block text-sm font-medium text-gray-700 p-1">Company Type</p>
        <div className="relative mt-1 flex items-center justify-center gap-2">
      ...
      {/* GST Number */}
      <div className='w-full col-span-3'>
        <p className="block text-sm font-medium text-gray-700 p-1">GST Number (optional)</p>
        <div className="relative mt-1 flex items-center justify-center gap-2">
      ...
      <div className='w-full'>
        ...
        <Input type="text" name="address_line" placeholder="Address Line 1" className="w-full mb-2 p-2 " color='secondary' />
        <div className="grid grid-cols-3 gap-2">
          <Input type="text" name="address_city" label="City" size='sm' className="p-2 " color='secondary' />
          <Input type="text" name="address_state" label="State" size='sm' className="p-2 " color='secondary' />
          <Input type="text" name="address_zip_code" label="ZIP / Postal Code" size='sm' className="p-2 " color='secondary' />
        </div>
        <Input type="text" name="address_country" label="Country" className="mt-2 w-full p-2 " color='secondary' />
      </div>

      {/* Billing Address */}
      <div className='w-full'>
        <div className="flex items-center justify-between mb-2">
          <p className="block text-sm font-medium text-gray-700">Billing Address</p>
          <div className='flex items-center'>
            <Switch aria-label="Billing address same as Address" size='sm' onValueChange={setSame} color='secondary'/> 
            <p className='text-xs pl-2'>Same as Address</p>
          </div>
        </div>
        {!same && (
          <>
            <Input type="text" name="billing_address_line" placeholder="Address Line 1" className="w-full mb-2 p-2 " color='secondary' />
            <div className="grid grid-cols-3 gap-2">
              <Input type="text" name="billing_city" label="City" size='sm' className="p-2 " color='secondary' />
              <Input type="text" name="billing_state" label="State" size='sm' className="p-2 " color='secondary' />
              <Input type="text" name="billing_zip_code" label="ZIP / Postal Code" size='sm' className="p-2 " color='secondary' />
            </div>
            <Input type="text" name="billing_country" label="Country" className="mt-2 w-full p-2 " color='secondary' />
          </>
        )}
        {same && (
      ...
      {/* Contact Information */}
      <div className='w-full'>
        <p className="block text-sm font-medium text-gray-700">Contact Person</p>
        <div className="relative mt-1 flex items-center justify-center gap-2">
