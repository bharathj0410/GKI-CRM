...
export default function Employee({ onEmployeeUpdated }) {
  ...
  const employee = filteredData.map((Employeesdata) => (
    <EmployeeCard
      ...
      onClick={() =>
        router.push(
          `/employee/details/${Employeesdata.employeeId || Employeesdata._id}`,
        )
      }
    />
  ));
        ...
        {data.length ? (
            ...
            <div className="mb-6 flex items-center justify-between h-full">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  of {data.length} employee{data.length !== 1 ? "s" : ""}
                </p>
              </div>
            </div>
          ...
          <div className="text-center py-32">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Start building your team by adding your first employee. Click the
              "Add Employee" tab above to get started.
            </p>
          </div>
        )}
      </div>
