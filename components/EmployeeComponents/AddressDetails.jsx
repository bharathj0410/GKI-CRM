...
export default function AddressDetails({
  ...
  const addressKey =
    addressType === "permanent" ? "permanentAddress" : "temporaryAddress";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900 font-semibold">
              {employee[addressKey]?.addressLine || "N/A"}
            </p>
          )}
        </div>
        <div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900 font-semibold">
              {employee[addressKey]?.pincode || "N/A"}
            </p>
          )}
        </div>
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900 font-semibold">
              {employee[addressKey]?.country || "N/A"}
            </p>
          )}
        </div>
      </div>
