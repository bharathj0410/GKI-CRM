...
import { Input, Select, SelectItem, Card, CardBody, Checkbox } from '@heroui/react'
        ...
        <div className='space-y-8'>
            ...
            <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Job Title / Role</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.jobTitle || 'N/A'}</p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Department / Team</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.department || 'N/A'}</p>
                        )}
                    </div>
                    <div>
                    ...
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Employment Type</label>
                        {isEditing ? (
                            <Select
                            ...
                            <p className='text-gray-900 font-semibold'>
                                {employmentTypes.find(t => t.value === employee.employmentType)?.label || 'N/A'}
                            </p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Manager / Supervisor Name</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.managerName || 'N/A'}</p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Work Location</label>
                        {isEditing ? (
                            <Select
                            ...
                            <p className='text-gray-900 font-semibold'>
                                {workLocations.find(l => l.value === employee.workLocation)?.label || 'N/A'}
                            </p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Salary</label>
                        {isEditing ? (
                            <Input
                ...
                <div className='mt-8 pt-6 border-t border-gray-200'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <div className='space-y-3'>
                            <p className='text-sm font-medium text-gray-700 mb-3'>Employment Status</p>
                            <div className='flex flex-col gap-3'>
                                <Checkbox
                                    isSelected={editedEmployee.isTempEmployee || false}
                                    onValueChange={(val) => handleInputChange('isTempEmployee', val)}
                                    isDisabled={!isEditing}
                                    classNames={{
                                        label: 'text-sm text-gray-700'
                                    }}
                                ...
                                <Checkbox
                                    ...
                                    onValueChange={(val) => handleInputChange('isPermanentEmployee', val)}
                                    isDisabled={!isEditing}
                                    classNames={{
                                        label: 'text-sm text-gray-700'
                                    }}
                        ...
                        <div className='bg-gradient-to-r from-secondary to-secondary/80 text-white rounded-lg p-6'>
                            ...
                            <div className='grid grid-cols-7 gap-2'>
                                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day) => (
                                    <div key={day} className='text-center font-bold text-sm opacity-90'>
                                        {day}
                                    </div>
                                ))}
                            </div>
