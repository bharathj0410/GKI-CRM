        ...
        <div className='mb-8'>
            ...
            <div className='mb-8 p-5 rounded-xl border border-blue-100 shadow-sm hover:shadow-md transition-shadow'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Account Holder Name</label>
                        {isEditing ? (
                            <Input
                                value={editedEmployee.bankDetails?.accountHolderName || ''}
                                onValueChange={(val) => handleInputChange('bankDetails', {
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.bankDetails?.accountHolderName || 'N/A'}</p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Bank Name</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.bankDetails?.bankName || 'N/A'}</p>
                        )}
                    </div>
                    <div className='md:col-span-2'>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Branch Name</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold'>{employee.bankDetails?.branchName || 'N/A'}</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className='mb-8 p-5 rounded-xl border border-purple-100 shadow-sm hover:shadow-md transition-shadow'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Account Number</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold font-mono'>{employee.bankDetails?.accountNumber ? '*'.repeat(employee.bankDetails.accountNumber.length - 4) + employee.bankDetails.accountNumber.slice(-4) : 'N/A'}</p>
                        )}
                    </div>
                    <div>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>Account Type</label>
                        {isEditing ? (
                            <Select
                            ...
                            <p className='text-gray-900 font-semibold'>
                                {accountTypes.find(t => t.value === employee.bankDetails?.accountType)?.label || 'N/A'}
                            </p>
                        )}
                    </div>
                    <div className='md:col-span-2'>
                        <label className='text-sm font-medium text-gray-600 mb-1.5 block'>IFSC Code</label>
                        {isEditing ? (
                            <Input
                            ...
                            <p className='text-gray-900 font-semibold font-mono'>{employee.bankDetails?.ifscCode || 'N/A'}</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className='p-5 rounded-xl border border-green-100 shadow-sm hover:shadow-md transition-shadow'>
                ...
                <div className='space-y-4'>
                    <p className='text-sm text-gray-600'>Upload the first page of your bank passbook for verification purposes.</p>
                                    ...
                                    <div className='flex items-center justify-between'>
                                        <div className='flex items-center gap-3 flex-1'>
                                            ...
                                            <div className='flex-1'>
                                                <p className='font-semibold text-gray-900'>Bank Passbook</p>
                                                <p className='text-xs text-gray-500 mt-1'>
                                                    {employee.bankDetails?.passbook?.uploadedAt 
                                                        ? new Date(employee.bankDetails.passbook.uploadedAt).toLocaleDateString()
                                                        : 'Pending Upload'
                                                    }
                                                </p>
                                            </div>
