...
export default function LoginPage() {
    ...
    if (newPassword.length > 0 && (newPassword.match(/[^a-z0-9]/gi) || []).length < 1) {
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-secondary via-purple-600 to-primary-600 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-purple-100 text-lg">
                        Powerful customer relationship management with advanced tools for sales, analytics, and team collaboration.
                    </p>
                </div>
                ...
                <div className="relative z-10 space-y-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-purple-100 text-sm">Role-based permissions ensure data security</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Customer Management</h3>
                            <p className="text-purple-100 text-sm">Track and manage customer relationships</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-purple-100 text-sm">Track performance and forecast revenue</p>
                        </div>
                    </div>
                </div>
                        ...
                        <CardBody className="p-8">
                            ...
                            <Form onSubmit={onSubmit} className="space-y-5">
                                    ...
                                    <>
                                        <div className="bg-warning-50 border-l-4 border-warning-500 rounded-lg p-4">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-warning-800 text-sm mb-1">Password Reset Required</p>
                                                    <p className="text-sm text-warning-700">Your account requires a password change. Please create a new secure password.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <Button 
                                    ...
                                    size="lg"
                                >
                                    {loading ? 'Processing...' : (requirePasswordReset ? 'Set Password & Login' : 'Sign In')}
                                </Button>
                            </Form>
