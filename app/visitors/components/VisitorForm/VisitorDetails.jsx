...
import { BuildingOffice2Icon, CubeIcon, DocumentTextIcon } from '@heroicons/react/16/solid';
...
export default function VisitorDetails({ formData }) {
  ...
  return (
    <div>
      <p className="font-black uppercase px-10 py-3 text-xl mb-5 rounded-xl">Visit Details</p>
      <div className="grid grid-cols-3 gap-3">
        <I18nProvider locale="en-GB">
          <DatePicker
            ...
            defaultValue={formData?.checkIn ? zonedToCalendarDateTime(formData?.checkIn) : now(getLocalTimeZone())}
            name="checkIn"
        ...
        >
          {(purposesOfVisit) => <SelectItem>{purposesOfVisit.label}</SelectItem>}
        </Select>
        {
