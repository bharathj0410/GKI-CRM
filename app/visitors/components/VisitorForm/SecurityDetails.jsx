...
export default function SecurityDetails({formData,setFiles,files}) {
    ...
    return (
        <div>
            <p className="font-black uppercase px-10 py-3 text-xl mb-5 rounded-xl">Security & Compliance</p>
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                >
                    {(materialsCarriedIn) => <SelectItem>{materialsCarriedIn.label}</SelectItem>}
                </Select>
            </div>

            <MultiFileUploader formData={formData} setFiles={setFiles} files={files}/>
        </div>
    )
}
