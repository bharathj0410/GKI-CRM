...
import { 
    Button, Card, CardBody, Input, Textarea, Select, SelectItem, 
    Modal, ModalContent, ModalHeader, ModalBody, ModalFooter,
    Chip, Avatar, Tabs, Tab, Autocomplete, AutocompleteItem
} from '@heroui/react'
import { DatePicker } from "@heroui/date-picker"
import { 
    ArrowLeftIcon, CameraIcon, DocumentIcon, CheckBadgeIcon,
    PencilIcon, TrashIcon, ArrowDownTrayIcon, PlusIcon, EyeIcon, XMarkIcon
...
export default function EmployeeDetailsPage({ params }) {
    ...
    const fetchEmployeeDetails = async () => {
        try {
            ...
            const response = await fetch(`/api/getEmployeeById?employeeId=${employeeId}`)
        ...
        return (
            <div className='flex items-center justify-center h-screen'>
                <div className='text-center'>
                    ...
                    <Button color='secondary' onPress={() => router.back()} className='mt-4'>
                        Go Back
                    </Button>
                </div>
            </div>
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100'>
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            {canDelete && (
                                <Button
                                    ...
                                    onPress={() => {/* TODO: Add delete handler */}}
                                >
                                    Delete
                                </Button>
                            )}
                            ...
                            <CardBody className='p-6'>
                                <div className='text-center'>
                                    <div className='relative inline-block mb-4'>
                                        <Avatar
                                            src={employee.photo || `https://ui-avatars.com/api/?name=${employee.name}&background=8b5cf6&color=fff&size=200`}
                                    ...
                                    <p className='text-sm text-gray-600 mb-3'>{employee.role || 'Employee'}</p>
                                    <div className='mt-4 flex justify-center gap-2'>
                                        <Chip size='md' color='secondary' variant='flat' className='font-medium'>
                        ...
                        <Card className='shadow-md'>
                            <CardBody className='p-6 space-y-4'>
                                <div>
                                    ...
                                    <p className='font-semibold text-gray-900'>{employee.employeeId || 'N/A'}</p>
                                </div>
                                {employee.dateOfJoining && (
                                    <div>
                                        <p className='text-xs text-gray-500'>Date of Joining</p>
                                        <p className='font-semibold text-gray-900'>{new Date(employee.dateOfJoining).toLocaleDateString()}</p>
                                    </div>
                                )}
                                {employee.bloodGroup && (
                                    <div>
                                    ...
                                    <CardBody className='p-8'>
                                        ...
                                        <div className='mb-8'>
                                            <div className='flex items-center gap-3 mb-6'>
                                                ...
                                                <h3 className='text-xl font-bold text-gray-950'>Address Details</h3>
                                            </div>
                                        ...
                                        <div className='mb-8'>
                                            <div className='flex justify-between items-center mb-6'>
                                                <div className='flex items-center gap-3 flex-1'>
                                                    <div className='w-1.5 h-8 bg-gradient-to-b from-secondary to-secondary/60 rounded-full'></div>
                                                    <h3 className='text-xl font-bold text-gray-950'>Government ID Information</h3>
                                                </div>
                                                {isEditing && (
                                                    <Button
                                                        size='sm'
                                            ...
                                            {governmentIds.length === 0 ? (
                                                <div className='text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300'>
                                                    <p className='text-gray-500'>No government IDs added yet</p>
                                                    {isEditing && (
                                                        <Button
                                                            size='sm'
                                                            color='secondary'
                                                                ...
                                                                <div className='flex justify-between items-start'>
                                                                    <div className='flex items-start gap-3 flex-1'>
                                                                        ...
                                                                        <div className='flex-1 min-w-0'>
                                                                            <p className='font-semibold text-gray-900'>{govId.type}</p>
                                                                            <p className='text-sm text-gray-600 font-mono mt-1'>{govId.number}</p>
                                                                    ...
                                                                    {isEditing && (
                                                                        <Button
                                                                            ...
                                                                            color='danger'
                                                                            onPress={async () => {
                                                                                const updated = governmentIds.filter((_, i) => i !== index)
                                                                                setGovernmentIds(updated)
                                                                                await updateEmployee({ governmentIds: updated })
                                                                            }}
                                                                        >
                                        ...
                                        <div className='mb-8 mt-4'>
                                            <div className='flex justify-between items-center mb-6'>
                                                <div className='flex items-center gap-3 flex-1'>
                                                    <div className='w-1.5 h-8 bg-gradient-to-b from-secondary to-secondary/60 rounded-full'></div>
                                                    <h3 className='text-xl font-bold text-gray-950'>Family Details</h3>
                                                </div>
                                                {isEditing && (
                                                    <Button
                                                        size='sm'
                                                        ...
                                                        <Card key={index} className='border hover:shadow-md transition-shadow'>
                                                            <CardBody className='p-4'>
                                                                <div className='flex gap-3'>
                                                                    <Avatar
                                                                        src={member.photo || `https://ui-avatars.com/api/?name=${member.name}&background=8b5cf6&color=fff`}
                                                                        className='w-16 h-16'
                                                                    />
                                                                            ...
                                                                            {isEditing && (
                                                                                <Button
                                                                                    ...
                                                                                    onPress={async () => {
                                                                                        ...
                                                                                        await updateEmployee({ familyMembers: updated })
                                                                                    }}
                                                                                >
                                                                                    <TrashIcon className='w-4 h-4' />
                                                                                </Button>
                                        ...
                                        <div className='mb-8'>
                                            <div className='flex items-center gap-3 mb-6'>
                                                <div className='w-1.5 h-8 bg-gradient-to-b from-secondary to-secondary/60 rounded-full'></div>
                                                <h3 className='text-xl font-bold text-gray-950'>Family Address</h3>
                                            </div>
                                                    ...
                                                    <label className='flex items-center gap-2 cursor-pointer'>
                                                        <input
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                if (checked) {
                                                                    handleInputChange('familyAddress', editedEmployee.permanentAddress || {})
                                                                }
                                            ...
                                            <div className='p-5 bg-gradient-to-br from-purple-50 to-purple-50/50 rounded-xl border border-purple-100 shadow-sm hover:shadow-md transition-shadow'>
                                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                                    <div className='md:col-span-2'>
                                                        ...
                                                        {isEditing ? (
                                                            <Textarea
                                                                value={editedEmployee.familyAddress?.addressLine || ''}
                                                                onValueChange={(val) => handleInputChange('familyAddress', {
                                                            ...
                                                            <p className='text-gray-900 font-semibold'>{employee.familyAddress?.addressLine || 'N/A'}</p>
                                                        )}
                                                    </div>
                                                    <div>
                                                        ...
                                                        {isEditing ? (
                                                            ...
                                                            <p className='text-gray-900 font-semibold'>{employee.familyAddress?.city || 'N/A'}</p>
                                                        )}
                                                    </div>
                                                    <div>
                                                        ...
                                                        {isEditing ? (
                                                            <Autocomplete
                                                                value={editedEmployee.familyAddress?.state || ''}
                                                                onValueChange={(val) => handleInputChange('familyAddress', {
                                                                    ...(editedEmployee.familyAddress || {}),
                                                                    state: val
                                                                })}
                                                            ...
                                                            <p className='text-gray-900 font-semibold'>{employee.familyAddress?.state || 'N/A'}</p>
                                                        )}
                                                    </div>
                                                    <div>
                                                        ...
                                                        {isEditing ? (
                                                            <Input
                                                                value={editedEmployee.familyAddress?.pincode || ''}
                                                                onValueChange={(val) => {
                                                            ...
                                                            <p className='text-gray-900 font-semibold'>{employee.familyAddress?.pincode || 'N/A'}</p>
                                                        )}
                                                    </div>
                                                    <div>
                                                        ...
                                                        {isEditing ? (
                                                            <Autocomplete
                                                                value={editedEmployee.familyAddress?.country || ''}
                                                                onValueChange={(val) => handleInputChange('familyAddress', {
                                                                    ...(editedEmployee.familyAddress || {}),
                                                                    country: val
                                                                })}
                                                            ...
                                                            <p className='text-gray-900 font-semibold'>{employee.familyAddress?.country || 'N/A'}</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <Card className='shadow-md mt-4'>
                                    <CardBody className='p-8'>
                                        <div className='flex justify-between items-center mb-8'>
                                            <div className='flex items-center gap-3'>
                                                <div className='w-1.5 h-8 bg-gradient-to-b from-secondary to-secondary/60 rounded-full'></div>
                                                <h3 className='text-xl font-bold text-gray-950'>Uploaded Documents</h3>
                                            </div>
                                            {canEdit && (
                                                <Button
                                                    color='secondary'
                                        ...
                                        {documents.length === 0 ? (
                                            <div className='text-center py-16 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300'>
                                                ...
                                                <p className='text-gray-400 text-sm mb-4'>Upload employee documents to get started</p>
                                                {canEdit && (
                                                    <Button
                                                        color='secondary'
                                                        variant='flat'
                                            ...
                                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                                                {documents.map((doc) => (
                                                    <Card key={doc.id} className='border hover:shadow-lg transition-shadow'>
                                                        <CardBody className='p-4'>
                                                            <div className='flex items-start gap-3'>
                                                                ...
                                                                <div className='flex-1 min-w-0'>
                                                                    <p className='font-semibold text-gray-900 truncate'>{doc.typeName}</p>
                                    ...
                                    <CardBody className='p-6'>
                                        {isVerified ? (
                                                    ...
                                                    <div className='bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden'>
                                                        ...
                                                        <div className='relative z-10'>
                                                            ...
                                                            <div className='flex items-start justify-between mb-6'>
                                                                <div>
                                                                    <h3 className='text-lg font-bold'>GKI COMPANY</h3>
                                                                    <p className='text-xs opacity-90'>Employee Identification Card</p>
                                                                </div>
                                                                <Chip 
                                                                    size='sm' 
                                                                    ...
                                                                    variant='flat'
                                                                >
                                                                    {employee.employeeType === 'temp_employee' ? 'TEMP' : 
                                                                     employee.employeeType === 'crm_user' ? 'PERM' : 'EMP'}
                                                                </Chip>
                                                            </div>
                                                            ...
                                                            <div className='flex items-center gap-5 mb-6'>
                                                                <div className='relative'>
                                                                    <Avatar
                                                                        src={employee.photo || `https://ui-avatars.com/api/?name=${employee.name}&background=fff&color=6366f1&size=200`}
                                                                ...
                                                                <div className='flex-1'>
                                                                    ...
                                                                    <p className='text-sm opacity-90 mb-2'>{employee.role || 'Employee'}</p>
                                                                    <div className='bg-white/20 backdrop-blur-sm rounded px-2 py-1 inline-block'>
                                                                        <p className='text-xs font-mono font-bold'>{employee.employeeId || 'N/A'}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className='bg-white/10 backdrop-blur-sm rounded-lg p-4 space-y-2 text-sm'>
                                                                <div className='flex justify-between'>
                                                                    ...
                                                                    <span className='font-semibold'>{employee.department || 'General'}</span>
                                                                </div>
                                                                {employee.bloodGroup && (
                                                                    <div className='flex justify-between'>
                                                                        <span className='opacity-80'>Blood Group:</span>
                                                                        <span className='font-bold text-red-300'>{employee.bloodGroup}</span>
                                                                    </div>
                                                                )}
                                                                <div className='flex justify-between'>
                                                            ...
                                                            <div className='mt-6 pt-4 border-t border-white/20'>
                                                                <div className='flex justify-between items-end'>
                                                                    <div>
                                                                        ...
                                                                        <p className='text-xs opacity-75 mt-1'>Employee Signature</p>
                                                                    </div>
                                                                    <div>
                                                                        <div className='h-8 w-32 border-b border-white/50'></div>
                                                                        <p className='text-xs opacity-75 mt-1'>Authorized By</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className='bg-gradient-to-br from-gray-800 via-gray-900 to-black p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden'>
                                                        ...
                                                        <div className='relative z-10 space-y-6'>
                                                            {/* Contact Information */}
                                                            <div>
                                                                <h4 className='text-sm font-bold mb-3 text-secondary-400'>CONTACT INFORMATION</h4>
                                                                <div className='space-y-2 text-sm'>
                                                                    ...
                                                                    {employee.address && (
                                                                        <div className='flex items-start gap-2'>
                                                                            ...
                                                                            <span className='text-xs opacity-90 line-clamp-2'>{employee.address}</span>
                                                                        </div>
                                                                    )}
                                                                </div>
                                                            </div>
                                                            ...
                                                            {(employee.emergencyContactName || employee.emergencyContact) && (
                                                                <div className='border-t border-white/10 pt-4'>
                                                                    <h4 className='text-sm font-bold mb-3 text-red-400'>EMERGENCY CONTACT</h4>
                                                                    <div className='space-y-2 text-sm'>
                                                                        ...
                                                                        {employee.emergencyContactRelation && (
                                                                            <div className='flex justify-between'>
                                                                                <span className='opacity-75'>Relation:</span>
                                                                                <span className='font-semibold'>{employee.emergencyContactRelation}</span>
                                                                            </div>
                                                                        )}
                                                                        {employee.emergencyContact && (
                                                                            <div className='flex justify-between'>
                                                                                <span className='opacity-75'>Phone:</span>
                                                                                <span className='font-semibold'>{employee.emergencyContact}</span>
                                                                            </div>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            {/* Important Notes */}
                                                            <div className='border-t border-white/10 pt-4'>
                                                                <h4 className='text-xs font-bold mb-2 text-yellow-400'>IMPORTANT NOTES</h4>
                                                                <ul className='text-xs opacity-75 space-y-1.5'>
                                                                    <li>• This card is property of GKI Company</li>
                                                            ...
                                                            <div className='border-t border-white/10 pt-4 flex justify-between items-center'>
                                                                <div className='text-xs opacity-50'>
                                                                    Issued: {employee.dateOfJoining ? new Date(employee.dateOfJoining).toLocaleDateString() : new Date().toLocaleDateString()}
                                                                </div>
                                                                <div className='bg-white/10 px-3 py-1 rounded'>
                                                                    <p className='text-xs font-mono'>#GKI-{employee.employeeId}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className='text-center py-12'>
                                                ...
                                                <h3 className='text-lg font-bold text-gray-900 mb-2'>Employee Not Verified</h3>
            ...
            {/* Photo Upload Modal */}
            <Modal isOpen={showPhotoModal} onClose={() => setShowPhotoModal(false)} size='2xl'>
                <ModalContent>
            ...
            <Modal isOpen={showDocModal} onClose={() => setShowDocModal(false)} size='lg'>
                <ModalContent>
                    <ModalHeader className='flex flex-col gap-1'>
                        <h3 className='text-xl font-bold'>Add Document</h3>
                        <p className='text-sm text-gray-500 font-normal'>Upload employee documents (PDF, Images)</p>
                    </ModalHeader>
                    <ModalBody>
                        <Select
                            label='Document Type'
                        ...
                        <div className='mt-2'>
                            ...
                            <div className='border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-secondary transition-colors'>
                                ...
                                {newDocFile ? (
                                    <div>
                                        <p className='text-sm font-semibold text-gray-700'>{newDocFile.name}</p>
                ...
                <ModalContent>
                    <ModalHeader className='flex items-center justify-between'>
                        <div>
                            ...
                            <p className='text-sm text-gray-500 font-normal'>{viewingDoc?.fileName}</p>
                        </div>
                    </ModalHeader>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <p className='text-sm text-gray-600 mb-4'>
                            By verifying this employee, you confirm that all documents and information have been reviewed and are accurate.
                        </p>
                        <Textarea
            ...
            {/* Government ID Modal */}
            <Modal isOpen={showGovIdModal} onClose={() => setShowGovIdModal(false)} size='2xl'>
                <ModalContent>
                    <ModalHeader className='flex flex-col gap-1'>
                        <h3 className='text-xl font-bold'>Add Government ID</h3>
                        <p className='text-sm text-gray-500 font-normal'>Add official government identification with validation</p>
                    </ModalHeader>
                    <ModalBody>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <Select
                            ...
                            <Input
                                label='ID Number'
                                placeholder={newGovIdType ? govIdTypesData.find(id => id.key === newGovIdType)?.placeholder || 'Enter ID number' : 'Select ID type first'}
                                ...
                                maxLength={newGovIdType ? govIdTypesData.find(id => id.key === newGovIdType)?.maxLength : 50}
                                description={newGovIdType ? `Format: ${govIdTypesData.find(id => id.key === newGovIdType)?.placeholder}` : ''}
                            />
                        </div>
                        ...
                        {newGovIdType && (
                            <div className='mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200'>
                                <p className='text-sm text-gray-700'>
                                    ...
                                    {govIdTypesData.find(id => id.key === newGovIdType)?.validationMessage}
                                </p>
                            </div>
                        )}
                    </ModalBody>
                        ...
                        <Button
                            ...
                            onPress={async () => {
                                if (newGovIdType && newGovIdNumber) {
                                    const validation = validateGovId(newGovIdType, newGovIdNumber)
                                    if (!validation.isValid) {
                                        setGovIdValidationError(validation.message)
                                        return
                                    }
                                    
                                    const stateLabel = indianStatesData.find(s => s.key === newGovIdState)?.label || newGovIdState
                                    const countryLabel = countriesData.find(c => c.key === newGovIdCountry)?.label || newGovIdCountry
                                    
                                    const newId = {
                                        type: govIdTypesData.find(id => id.key === newGovIdType)?.label || newGovIdType,
                            ...
                            isDisabled={!newGovIdType || !newGovIdNumber || !!govIdValidationError}
                        >
                            Add ID
                        </Button>
                    </ModalFooter>
            ...
            {/* Family Member Modal */}
            <Modal isOpen={showFamilyModal} onClose={() => setShowFamilyModal(false)} size='2xl'>
                <ModalContent>
                    <ModalHeader className='flex flex-col gap-1'>
                        <h3 className='text-xl font-bold'>Add Family Member</h3>
                        <p className='text-sm text-gray-500 font-normal'>Add family member details</p>
                    </ModalHeader>
                    <ModalBody>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <Input
                                ...
                                onValueChange={(val) => setNewFamilyMember({ ...newFamilyMember, name: val })}
                                variant='bordered'
                                size='lg'
                            />
                            ...
                            >
                                ...
                                <SelectItem key='Brother' value='Brother'>Brother</SelectItem>
                                <SelectItem key='Sister' value='Sister'>Sister</SelectItem>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (file) {
                                        const reader = new FileReader()
                                        reader.onloadend = () => {
                                            setNewFamilyMember({ ...newFamilyMember, photo: reader.result })
                                        }
                                        reader.readAsDataURL(file)
                                    }
                                }}
                            ...
                            <div className='border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-secondary transition-colors'>
                                {newFamilyMember.photo ? (
                                    ...
                                    <div>
                                        ...
                                        <p className='text-sm text-gray-600 mb-3'>Click to upload photo</p>
                                        <Button
                                            color='secondary'
                                            variant='flat'
                                            onPress={() => familyPhotoInputRef.current?.click()}
                    ...
                    <ModalFooter>
                        <Button variant='light' onPress={() => {
                            ...
                            setNewFamilyMember({ name: '', relationship: '', contact: '', photo: '' })
                        }}>
                            Cancel
                        </Button>
                        <Button
                            color='secondary'
                            onPress={async () => {
                                if (newFamilyMember.name && newFamilyMember.relationship && newFamilyMember.contact) {
                            ...
                            isDisabled={!newFamilyMember.name || !newFamilyMember.relationship || !newFamilyMember.contact}
                        >
                            Add Family Member
                        </Button>
                    </ModalFooter>
