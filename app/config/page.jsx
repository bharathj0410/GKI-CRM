...
export default function ConfigurationPage() {
  ...
  const filteredSections = CONFIG_SECTIONS.filter(
    (section) =>
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Centralized control panel for application-wide settings. Changes
            made here reflect across the entire system.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-orange-800 leading-relaxed">
                Any changes made to these configurations will{" "}
                <strong>immediately affect all related features</strong> across
                the application. Always verify your changes and save them before
        ...
        <div className="mb-8">
          ...
          {searchQuery && (
            <p className="mt-2 text-sm text-gray-600">
              Found {filteredSections.length} configuration
